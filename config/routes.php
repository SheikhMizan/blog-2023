...
$routes->scope('/', function (RouteBuilder $builder) {
    ...
    $builder->connect('/', ['controller' => 'Questions', 'action' => 'index']);

    $builder->connect('/questions/add', ['controller' => 'Questions', 'action' => 'add']);
    ...
    $builder
        ->connect('/vote/:dir/:model/:id', ['controller' => 'Votes', 'action' => 'vote'])
        ->setPass(['dir', 'model', 'id']);
